...
- **Location:** REDACTED-CITY · Mobile in France

### Key Experience
- **Company Name (Stage Jan–Jun 2025):** +500% speed, -99% costs · 18K Excel rows + 1772 PDF pages · 476 multi-agent test scenarios
- **REDACTED-EMPLOYER (2021–2024):** Python/SNMP automation · -70% manual interventions · Power BI dashboards 1500+ users
- **REDACTED-EMPLOYER (2017–2019):** VOIP support · SolarWinds · -30% downtime
- **REDACTED-EMPLOYER (2010–2013):** QA inspection TETRA network 78 sites
...
- **Cisco Switch & IP Phone Manager:** v1 REDACTED-EMPLOYER (70 switches, SNMP, -70% site visits) → v2 full-stack (FastAPI, Next.js, PostgreSQL/PostGIS, Docker, Telegram alerts)
